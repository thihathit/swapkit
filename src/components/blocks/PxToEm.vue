    ...
    <div class="form-layout-basic convertor-fields">
      <div class="field-elements">
        ...
        <div class="has-element-suffix">
          <input type="number" v-model="states.relation" @input="toBoth" />
      ...
      <div class="field-elements">
        ...
        <div class="has-element-suffix">
          <input type="number" step="any" v-model="states.px" @input="toEM" />
      ...
      <div class="field-elements">
        ...
        <div class="has-element-suffix">
          <input type="number" step="any" v-model="states.em" @input="toPX" />
